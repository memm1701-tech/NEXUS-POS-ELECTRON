...
contextBridge.exposeInMainWorld('nexusAPI', {
    ...
    obtenerPresupuestosLocal: (filtro, companyId, branchId) => ipcRenderer.invoke('obtener-presupuestos-local', filtro, companyId, branchId),
    marcarPresupuestoFacturado: (id) => ipcRenderer.invoke('marcar-presupuesto-facturado', id),
    guardarPresupuestoMaestro: (datos) => ipcRenderer.invoke('guardar-presupuesto-local', datos),
    obtenerPresupuestosMaestro: (filtro, companyId, branchId) => ipcRenderer.invoke('obtener-presupuestos-local', filtro, companyId, branchId),
